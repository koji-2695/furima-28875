class FormObject
  ...
  with_options numericality: { other_than: 0 , only_integer: true} do
    ...
    def save
      ...
      Address.create(postal_code: postal_code, municipality: municipality, phone_number: phone_number, house_number: house_number, building_name: building_name, )
      Purchase.create(user_id: user_id, list_id: list_id, )
